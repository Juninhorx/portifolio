...
const dataProjects = [
  {
    ...
    description: 'Este projeto foi desenvolvido com o intuito de mostrar o meu trabalho, as tecnologias que uso no dia a dia e algun projetos pessoais. Com este projeto desenvolvi habilidades de front-end, design, responsividade e também consumi uma api para o envio dos e-mails de contato.',
  ...
  },
  {
    ...
    title: 'Buscador Cep',
    description: 'Trata-se de um buscador onde o usuário pesquisa um código CEP e retorna os dados, como estado, cidade, bairro e rua. Neste projeto trabalhei o consumo de APIs e o tratamento de dados.',
